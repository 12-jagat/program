...
st.markdown(custom_css, unsafe_allow_html=True)
# Custom CSS for white-creamish background and modern styling
custom_css = """
<style>
/* Background with creamish-white tone */
[data-testid="stAppViewContainer"] {
    background-color: #f8f8f1; /* Soft creamish white background */
...
/* Sidebar Styling */
[data-testid="stSidebar"] {
    background-color: #ffffff; /* Light cream color for sidebar */
    color: #2c2c2c;
    border-right: 2px solid #e0e0e0; /* Soft border color */
}
...
[data-testid="stSidebar"] h2, 
[data-testid="stSidebar"] h3 {
    color: #2c2c2c; /* Sidebar text color */
    font-weight: bold;
    text-transform: uppercase;
}
...
/* Data Table */
table {
    background-color: #ffffff; /* Table with white background */
    border-collapse: collapse;
    margin: auto;
    color: #2c2c2c;
...
/* Charts */
.plotly-chart {
    background: #ffffff; /* Charts with white background */
    border-radius: 12px;
    padding: 10px;
